...
HD_PWD='E:/Mycode/Verilog/pwm_dec1/pwm_dec1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_design_1_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source pwm_design_1_wrapper.tcl -notrace
