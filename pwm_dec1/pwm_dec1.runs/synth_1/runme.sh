...
HD_PWD='E:/Mycode/Verilog/pwm_dec1/pwm_dec1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_design_1_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pwm_design_1_wrapper.tcl
