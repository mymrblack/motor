...
################################################################
# This is a generated script based on design: pwm_design_1
#
...
# source pwm_design_1_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set pwmd [ create_bd_port -dir O pwmd ]
  set pwmo [ create_bd_port -dir O pwmo ]
  set sig_in [ create_bd_port -dir I sig_in ]

  # Create instance: dec_pwm_0, and set properties
  set dec_pwm_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:dec_pwm:1.0 dec_pwm_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins dec_pwm_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net B_1 [get_bd_ports B] [get_bd_pins dec_pwm_0/B]
  connect_bd_net -net clr_1 [get_bd_ports clr] [get_bd_pins dec_pwm_0/clr]
  connect_bd_net -net dec_pwm_0_pwmd [get_bd_ports pwmd] [get_bd_pins dec_pwm_0/pwmd]
  connect_bd_net -net dec_pwm_0_pwmo [get_bd_ports pwmo] [get_bd_pins dec_pwm_0/pwmo]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins dec_pwm_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins dec_pwm_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net sig_in_1 [get_bd_ports sig_in] [get_bd_pins dec_pwm_0/sig_in]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dec_pwm_0/S00_AXI/S00_AXI_reg] SEG_dec_pwm_0_S00_AXI_reg
...
preplace port sig_in -pg 1 -y 430 -defaultsOSRD
preplace port clr -pg 1 -y 470 -defaultsOSRD
preplace port pwmo -pg 1 -y 410 -defaultsOSRD
preplace port pwmd -pg 1 -y 430 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 350 -defaultsOSRD
preplace inst dec_pwm_0 -pg 1 -lvl 3 -y 420 -defaultsOSRD
...
preplace netloc clr_1 1 0 3 NJ 460 NJ 460 NJ
preplace netloc sig_in_1 1 0 3 NJ 440 NJ 440 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 1 670
preplace netloc dec_pwm_0_pwmo 1 3 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 390
preplace netloc dec_pwm_0_pwmd 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 250 370
...
preplace netloc B_1 1 0 3 NJ 450 NJ 430 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 370
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 260 380 450 N
levelinfo -pg 1 0 200 530 800 920 -top 0 -bot 520
",
}
