...
#
# Generated by Vivado on Wed Aug 03 16:13:24 +0800 2016
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: pwm_design_1.sh [-help]
# usage: pwm_design_1.sh [-lib_map_path]
# usage: pwm_design_1.sh [-noclean_files]
# usage: pwm_design_1.sh [-reset_run]
#
...
# executing this script. Please type 'pwm_design_1.sh -help' for more information.
#
...
# Design libraries
design_libs=(xil_defaultlib processing_system7_bfm_v2_0_5 lib_cdc_v1_0_2 proc_sys_reset_v5_0_9 generic_baseblocks_v2_1_0 fifo_generator_v13_1_1 axi_data_fifo_v2_1_8 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_9 axi_protocol_converter_v2_1_9)

# Simulation root library directory
sim_lib_dir="vcs"

# Script info
echo -e "pwm_design_1.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/pwm_design_1/ipshared/xilinx.com/dec_pwm_v1_0/hdl/frq_cal.v" \
    "$ref_dir/../../../bd/pwm_design_1/ipshared/xilinx.com/dec_pwm_v1_0/hdl/pwm.v" \
    "$ref_dir/../../../bd/pwm_design_1/ipshared/xilinx.com/dec_pwm_v1_0/hdl/dec_pwm_v1_0_S00_AXI.v" \
    "$ref_dir/../../../bd/pwm_design_1/ipshared/xilinx.com/dec_pwm_v1_0/hdl/dec_pwm_v1_0.v" \
    "$ref_dir/../../../bd/pwm_design_1/ip/pwm_design_1_dec_pwm_0_0/sim/pwm_design_1_dec_pwm_0_0.v" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/pwm_design_1/ip/pwm_design_1_processing_system7_0_0/sim/pwm_design_1_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/pwm_design_1/ip/pwm_design_1_rst_processing_system7_0_100M_0/sim/pwm_design_1_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/pwm_design_1/hdl/pwm_design_1.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/pwm_design_1/ip/pwm_design_1_auto_pc_0/sim/pwm_design_1_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pwm_design_1 xil_defaultlib.glbl -o pwm_design_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pwm_design_1_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./pwm_design_1.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key pwm_design_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc pwm_design_1_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./pwm_design_1.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: pwm_design_1.sh [-help]\n\
Usage: pwm_design_1.sh [-lib_map_path]\n\
Usage: pwm_design_1.sh [-reset_run]\n\
Usage: pwm_design_1.sh [-noclean_files]\n\n\
