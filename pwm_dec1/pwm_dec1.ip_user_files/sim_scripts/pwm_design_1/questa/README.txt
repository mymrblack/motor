...
#
# Generated by export_simulation on Wed Aug 03 16:13:24 +0800 2016
#
################################################################################
...
switch to the './pwm_design_1.sh' script.

./pwm_design_1.sh -reset_run
...
./pwm_design_1.sh -noclean_files

For more information on the script, please type './pwm_design_1.sh -help'.
